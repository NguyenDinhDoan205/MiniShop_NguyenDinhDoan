    ...
    if ($catename == "") {
        ...
        if (isset($_FILES["image"]) && $_FILES["image"]["error"] == 0) {
            ...
            if (!in_array($extension, $allowed)) {
                $error = "Chỉ được upload JPG, JPEG, PNG, GIF hoặc WEBP.";
                ...
                if (move_uploaded_file($fileTmp, $uploadDir . $newImage)) {
        ...
        <form action="edit.php?id=<?= $id ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="catename" class="form-control"
                       value="<?= htmlspecialchars($_POST["catename"] ?? $category->catename) ?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if (!empty($category->image)): ?>
                    <img id="currentImage" src="../../../uploads/categories/<?= htmlspecialchars($category->image) ?>" width="120" class="img-thumbnail">
                <?php else: ?>
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">Không chọn ảnh mới thì giữ nguyên ảnh cũ.</small>
                <br>
                <!-- Preview ảnh mới -->
                <img id="preview" src="#" alt="Preview ảnh mới" style="display:none; margin-top:10px;" width="120" class="img-thumbnail">
            </div>
